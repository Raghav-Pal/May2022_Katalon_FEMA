...
WS.sendRequest(findTestObject('API/GetUserList'), FailureHandling.STOP_ON_FAILURE)
...
not_run: WebUI.verifyElementPresent(findTestObject('Page_CURA Healthcare Service/button_Login'), 5)

not_run: WebUI.waitForElementVisible(findTestObject(null), 10)

not_run: WebUI.uploadFile(findTestObject(null), '')

not_run: WebUI.uploadFileWithDragAndDrop('')
